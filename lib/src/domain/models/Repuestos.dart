...
class Repuesto {
  ...
  factory Repuesto.fromJson(Map<String, dynamic> json) => Repuesto(
    ...
    precio: double.parse(json["precio"].toString()),  // Usar double.parse para convertir el precio a double
    disponibilidad: json["disponibilidad"],
    voltaje: double.parse(json["voltaje"].toString()),  // Usar double.parse para convertir el voltaje a double
    imagen: json["imagen"],
  );
